...
const skillLibrary = {
  ...
  karma: [
    ...
    { id: 'karma_charge', name: '蓄力', color: 'orange', cost: '2步', description: '给自己上一层鸡血并进入蓄力状态（本回合无法移动或使用技能）。下回合开始消耗1层蓄力，30%概率获得额外技能“爆”（技能池一次性只能有一个）。', probability: '20%', minLevel: 50 },
